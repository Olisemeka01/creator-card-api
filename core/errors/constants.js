...
const ERROR_CODE = {
  ...
  AC05: 'ACCESS_CODE_PUBLIC_ONLY',
  NF01: 'CARD_NOT_FOUND',
  NF02: 'CARD_IS_DRAFT',
  AC03: 'ACCESS_CODE_REQUIRED_RETRIEVAL',
...
const ERROR_STATUS_CODE_MAPPING = {
  ...
  // Creator Card custom error code mappings
  SLUG_EXISTS: 400,
  ACCESS_CODE_REQUIRED: 400,
  ACCESS_CODE_PUBLIC_ONLY: 400,
  CARD_NOT_FOUND: 404,
  CARD_IS_DRAFT: 404,
  ACCESS_CODE_REQUIRED_RETRIEVAL: 403,
